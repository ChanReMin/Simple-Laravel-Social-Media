...
<body>
<header class="header-bar mb-3" style="background-color: #09c158">
    <div class="container d-flex flex-column flex-md-row align-items-center p-2">
        <h4 class="my-0 mr-md-auto font-weight-normal"><a href="/" class="text-white">OurApp</a></h4>
        @if(auth()->check())
            <h4 class="my-0 mr-md-auto font-weight-normal"><a href="/all-users" class="text-white">Users</a></h4>
        @endif
        @auth
            ...
            <form action="/login" method="POST" class="mb-0 pt-2 pt-md-0">
                ...
                <div class="row align-items-center">
                    <div class="col-md mr-0 pr-md-0 mb-3 mb-md-0">
                        <input name="login_username" class="form-control form-control-sm input-dark" type="text"
                               placeholder="Username" autocomplete="off"/>
                    </div>
                    <div class="col-md mr-0 pr-md-0 mb-3 mb-md-0">
                        <input name="login_password" class="form-control form-control-sm input-dark" type="password"
...
<!-- header ends here -->
    ...
    {{$slot}}
<!-- footer begins -->
<footer class="footer fixed-bottom border-top text-center small text-muted py-3">
